...
1. Shipping within India is INR 150 irrespective of the number of items bought.
2. Shipping is free on purchases above INR 1,950
3. Orders are delivered within 5 to 6 working days. Unless otherwise specifically mentioned in the product details.
4. Delivery of all orders will be duly done to the address as mentioned by you at the time of placing the order. In case of modifications, kindly drop us a mail at info@suta.in within 2 hours of placing the order.

INTERNATIONAL-

1. Shipping charges for our international customers will be calculated during check out depending on the order value and dimensions of your order
2. Any custom charges or VAT has to be borne by the customer

(Our I/E code is 0316511935)
3. Our delivery partner is DHL.
4. From 1st July 2021, VAT would be applicable on all shipments delivered in EU. The duty and VAT has to be borne by the customers.
5. Orders are delivered within 7-8 working days.

Unless otherwise specifically mentioned in the product details.
6. Delivery of all orders will be duly done to the address as mentioned by you at the time of placing the order. In case of modifications, kindly drop us a mail at info@suta.in within 2 hours, of placing order.
