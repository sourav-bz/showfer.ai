      ...
      <main className="flex h-full">
            ...
            <div className="flex">
              ...
              >
                ...
                <div className="border-t border-[#E3E4EC] py-[15px] flex justify-end">
                  <button className="bg-[#6D67E4] text-white px-4 py-2 rounded-[10px] w-[135px] h-[40px]">
                    Fetch Links
                  </button>
                </div>
              </div>
        ...
        <div className="w-1/3 p-8 flex items-center justify-center">
          <div className="w-[450px]">
            ...
            <h2 className="text-[16px] font-medium mb-[15px]">
              Links found (246)
            </h2>
            <div>
              {[...Array(10)].map((_, index) => (
                ...
                >
                  ...
                  <span className="text-[14px]">
                    https://www.dummydomain.com/
                  </span>
                  <div className="cursor-pointer bg-[#FF3B301A] rounded-[6px] w-[30px] h-[30px] flex items-center justify-center ml-auto">
                    <Image
