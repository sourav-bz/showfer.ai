...
Command: npx gltfjsx@6.5.0 public/models/1c_Character.gltf -o components/Characters/Showfer1c.tsx -r public 
*/
// @ts-nocheck
...
type GLTFResult = GLTF & {
  ...
  materials: {
    ["1st_Character_Baked"]: THREE.MeshStandardMaterial;
  };
  animations: GLTFAction[];
};

export default function Conrad(props) {
  const { nodes, materials } = useGLTF(
    "/models/1c_Character.gltf"
  ) as GLTFResult;
  ...
  return (
    <group {...props} dispose={null}>
      <mesh
        ...
        material={materials["1st_Character_Baked"]}
...
useGLTF.preload("/models/1c_Character.gltf");
